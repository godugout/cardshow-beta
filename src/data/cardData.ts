...
export const cardData: CardData[] = [
  {
    ...
    tags: ["music", "legends", "basketball", "tribute"],
    userId: "user-1",
    effects: ["Holographic"],
  ...
  },
  {
    ...
    tags: ["basketball", "legends", "chicago", "goat"],
    userId: "user-1",
    effects: ["Refractor"],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  },
  {
    ...
    tags: ["music", "legends", "memphis", "elvis"],
    userId: "user-1",
    effects: ["Chrome"],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  },
  {
    ...
    tags: ["hip-hop", "duke", "legends", "intensity"],
    userId: "user-1",
    effects: ["Vintage"],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  },
  {
    ...
    tags: ["hip-hop", "brooklyn", "nets", "hometown"],
    userId: "user-1",
