...
const Gallery = () => {
  ...
  const completeTutorial = () => {
    ...
    showToast.info("Tutorial completed", "You can access help anytime via the info icon");
  };
  ...
  const handleCardClick = (cardId: string) => {
    ...
    if (!hasSeenViewer) {
      showToast.info("Tip: Interactive Card Viewer", "Try dragging the card or using the effect controls for an immersive experience");
    }
  };
  ...
  const handleRefresh = async () => {
    ...
    showToast.success("Gallery refreshed", "Your card collection has been refreshed");
  };
